...
def make_env(rank, env_id, seed, allow_early_resets, env_interface,
    ...
    warp_frame = False
    render_metric = False
    transpose_frame = True

    def _thunk():
        #env = env_interface.create_from_id(env_id)
        env = env_interface.create_from_id(env_interface, "maze2d-medium-v2")
        ...
        env = env_interface.env_trans_fn(env_interface, env, set_eval)
        ...
        env = env_interface.final_trans_fn(env_interface, env)
